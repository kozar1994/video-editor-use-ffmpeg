            ...
            <div className="ml-3">
              <span
                className={`text-sm font-semibold block ${
                  mergeTasks ? "text-blue-900" : "text-slate-700"
                }`}
              >
        ...
        <div
          className={`mt-4 p-4 rounded-xl text-sm border-2 ${
            exportStatus.includes("failed") || exportStatus.includes("Error")
              ...
              : "bg-gray-50 border-gray-100 text-slate-700 font-medium"
          }`}
        >
          <div className="flex items-start">
            ...
            <div>
              <span className="uppercase text-[10px] tracking-wider font-bold block mb-1 opacity-60 text-slate-500">
                System Status
              </span>
              {exportStatus}
            </div>
